    ...
    <div className="bg-gray-50 min-h-screen py-16 text-xl">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 space-y-4 h-fit text-xl">
          ...
          <p><strong>Country:</strong> {program["Country/Region"]}</p>
          <p><strong>Agency:</strong> {program["Government Agency"]}</p>
          <p><strong>Launched:</strong> {program["Year Launched"]}</p>
          <p><strong>Duration:</strong> {program.Duration}</p>
          <p><strong>Status:</strong> {program["Current Status"]}</p>
      ...
      <div className="bg-white rounded-xl shadow-md p-8 width=max mx-100 mt-16">
            ...
            <p className="text-gray-600 mb-6">
              ...
              emergencies, participate in conservation activities, or support
              this initiative.
            </p>
